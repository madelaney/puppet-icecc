...
1. [Setup - The basics of getting started with icecc](#setup)
    * [What icecc affects](#what-icecc-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with icecc](#beginning-with-icecc)
